...
namespace sloth {
    ...
    export enum PWMChn {
        //% blockId="Right_leg" block="Right leg"
        Right_Leg = 8,
        //% blockId="Right_Foot" block="Right Foot"
        Right_Foot = 9,
        //% blockId="Left_Foot" block="Left Foot"
        Left_Foot = 10,
        //% blockId="Left_leg" block="Left leg"
        Left_Leg = 11,
        CH1 = 0,
        CH2 = 1,
        CH3 = 2,
    ...
    export enum action_name {
        //% blockId="walk" block="walk"
        walk = 0,
        //% blockId="walk_backward" block="walk backward"
        walk_backward = 1,
        //% blockId="turn_left" block="turn left"
        turn_left = 2,
        //% blockId="turn_right" block="turn right"
        turn_right = 3,
        //% blockId="moonwalk_left" block="moonwalk left"
        moonwalk_left = 4,
        //% blockId="moonwalk_right" block="moonwalk right"
        moonwalk_right = 5,
        //% blockId="shake_left" block="shake left"
        shake_left = 6,
        //% blockId="shake_right" block="shake right"
        shake_right = 7,
        //% blockId="go_up_and_down" block="go up and down"
        go_up_and_down = 8,
        //% blockId="swing" block="swing"
        swing = 9,
        //% blockId="walk_boldly" block="walk boldly"
        walk_boldly = 10,
        //% blockId="walk_backward_boldly" block="walk backward boldly"
        walk_backward_boldly = 11,
        //% blockId="walk_shyly" block="walk shyly"
        walk_shyly = 12,
        //% blockId="walk_backward_shyly" block="walk backward shyly"
        walk_backward_shyly = 13,
        //% blockId="big_swing" block="big swing"
        big_swing = 14
    }
    ...
    */
    //% blockId=sloth_set_pwm block="sloth set pwm %channel|on: %on|off: %off"
    //% advanced=true
    //% weight=20
     ...
     * Set servo to degree(0~180),
        ...
        left_leg = CH9
    */
    //% blockId=sloth_servo_write block="sloth servo write %channel|Angle %degree"
    //% advanced=true
    //% weight=50
     ...
     * @param speed ; eg: 50
    */
    //% blockId=sloth_servo_write_all block="sloth servo write all %angles"
    //% weight=30
    //% advanced=true
     ...
     * @param speed ; eg: 50
    */
    //% blockId=sloth_servo_move block="sloth servo move %target| %speed|dps"
    //% weight=40
    //% advanced=true
     ...
     */
    //% blockId=sloth_stand_still block="sloth stand still"
     ...
     */
    //% blockId=sloth_set_offset block="sloth set offset | Right leg %o3| Left leg %o1| Right foot %o4| Left foot %o2"
    //% weight=45
    //% o1.min=-30 o1.max=30
    //% o2.min=-30 o2.max=30
    //% o3.min=-30 o3.max=30
     ...
     */
    //% blockId=sloth_set_gesture block="sloth set gesture | Left leg %o1| Left foot %o2| Right leg %o3| Right foot %o4"
    //% o1.min=-90 o1.max=90
    //% o2.min=-90 o2.max=90
    //% o3.min=-90 o3.max=90
    //% o4.min=-90 o4.max=90
     ...
     * @param speed ; eg: 50
     */
    //% blockId=sloth_do_action block="%action=sloth_actions|%step|step %speed|speed"
     ...
     */
    //% blockId=sloth_cali_by_button block="sloth cali by button"
     ...
     */
    //% blockId=sloth_volume_of_heard block="sloth volume of heard"
     ...
     */
    //% blockId=sloth_mic_get_voice block="sloth mic get voice |%threshold"
     ...
     **/
    //% blockId=sloth_IR_detect_obstacle block="sloth IR detect obstacle"
     ...
     * servo sweep
     **/
    //% blockId=sloth_servo_sweep block="sloth servo sweep"
    //% weight=55
